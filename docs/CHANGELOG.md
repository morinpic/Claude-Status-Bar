...
- GitHub repository link icon in Settings footer
...
- Redesign notification messages with `[ ! ]` / `[✓]` prefix style
- Notification style now matches selected icon design (Status Icons / Classic emoji / Vibe emoji)
- Localize component status text in notifications (degraded performance / partial outage / major outage)
...
- Debug: polling countdown timer in debug menu header
...
[2.6.0]: https://github.com/morinpic/Claude-Status-Bar/compare/v2.5.0...v2.6.0
